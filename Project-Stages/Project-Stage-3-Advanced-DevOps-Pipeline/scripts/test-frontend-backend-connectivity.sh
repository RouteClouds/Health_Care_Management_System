...
echo "   $FRONTEND_URL"
echo ""
echo "🔍 Stage-2 Issue Check:"
echo "   - Frontend should use /api instead of localhost:3002/api"
echo "   - If API calls fail, rebuild frontend with Vite environment variables"
echo "   - See TROUBLESHOOTING.md for complete Stage-2 issue resolution"
