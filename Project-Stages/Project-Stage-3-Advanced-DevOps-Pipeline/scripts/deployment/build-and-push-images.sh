...
# Healthcare Management System - Stage 3 Docker Image Build and Push Script
# Enhanced Docker build with testing, security scanning, and multi-stage builds

set -e

echo "🚀 Stage 3: Building and Pushing Docker Images"
echo "=============================================="
...
check_docker_login() {
    ...
    if [ -z "$DOCKER_USERNAME" ]; then
        ...
        echo "3. Run: docker login"
        echo "4. Enter your Docker Hub username and ACCESS TOKEN (not password)"
        echo ""
...
echo "• If push fails: Verify Docker Hub login with 'docker login' (use access token, not password)"
...
echo ""
echo "🎉 Stage 3 Docker images are ready!"
